...
import { generateCharts_ComputationalDelay_Vs_round ,generateComputationalDelayChart, generateComputationalDelayChartp, generateComputationalDelayChartx} from "./generate_chart";
...
async function testMultipleNodeConfigs() {
    const nodesConfig = [50, 40, 30, 20, 10];  // Différents nombres de nœuds à tester
    let delays: number[] = [];
