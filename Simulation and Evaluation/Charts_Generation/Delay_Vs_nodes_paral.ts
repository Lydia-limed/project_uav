...
const QUICKCHART_BASE_URL = "https://quickchart.io/chart/render/zm-1bb814f9-aff9-4702-bf20-cbafe8d6900b";
...
export async function generateChart(nodes: number[], delays: number[]) {
    ...
    const savePath = path.join(saveDir, 'Delay_Vs_nodes_paral.png');
